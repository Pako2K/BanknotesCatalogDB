...
CREATE TABLE public.bva_variant (
    ...
    bva_not_issued bit(1) DEFAULT B'0' NOT NULL,
    bva_pri_id integer,
    ...
    bva_is_specimen bit(1) DEFAULT B'0' NOT NULL,
    bva_is_commemorative bit(1) DEFAULT B'0' NOT NULL,
    bva_is_numis_product bit(1) DEFAULT B'0' NOT NULL,
    bva_is_replacement bit(1) DEFAULT B'0' NOT NULL,
    bva_is_error bit(1) DEFAULT B'0' NOT NULL,
    bva_mintage integer,
...
--
-- Name: iss_issuer_iss_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: mat_material_mat_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: pri_printer_pri_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
