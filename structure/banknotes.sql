...
CREATE TABLE public.bva_variant (
    ...
    bva_not_issued bit(1) DEFAULT 0 NOT NULL,
    bva_pri_id integer,
    ...
    bva_is_specimen bit(1) DEFAULT 0 NOT NULL,
    bva_is_commemorative bit(1) DEFAULT 0 NOT NULL,
    bva_is_numis_product bit(1) DEFAULT 0 NOT NULL,
    bva_is_replacement bit(1) DEFAULT 0 NOT NULL,
    bva_is_error bit(1) DEFAULT 0 NOT NULL,
    bva_mintage integer,
